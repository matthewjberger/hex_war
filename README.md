...
A hex-based war game built with the [Nightshade](https://github.com/matthewjberger/nightshade) game engine.
...
4. Add `~/Downloads/hex_war` as a non-steam game in Steam
